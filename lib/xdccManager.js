(function(µ,SMOD,GMOD,HMOD,SC){
	...
	xdccManager.downloadXDCC=function(signal,xdccDownload)
	{
		...
		.then(function(config)
		{
			...
			var messagePromise=SC.ircManager.connect(xdccDownload.dataSource.network);
			...
			return messagePromise.then(()=>SC.ircManager.message(xdccDownload.dataSource.network,xdccDownload.dataSource.user,"XDCC SEND #"+xdccDownload.dataSource.packnumber));
		})
		.catch(signal.reject);
	};
